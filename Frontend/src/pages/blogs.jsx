    ...
    <div className="min-h-screen bg-gray-50 py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col items-center mb-10">
          <h1 className="text-3xl font-bold text-purple-600 mb-15 text-center">AI Insights &amp; Guides</h1>
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-7">
          {filteredBlogs.length === 0 ? (
            ...
            filteredBlogs.map((b) => (
              <article key={b.id} className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition">
