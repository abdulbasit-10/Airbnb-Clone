...
export default function AdvertisePage() {
	return (
		<div className="min-h-screen bg-gray-50 flex flex-col items-center py-25">
			...
			{/* Heading */}
			<h1 className="text-2xl sm:text-3xl font-bold text-green-600 text-center mb-2">Advertise Your AI Tool</h1>
			...
			<div className="flex flex-col items-start mb-10 w-full max-w-5xl">
				<div className="bg-white border border-green-200 rounded-xl shadow-lg p-8 w-full max-w-xs flex flex-col items-center">
					...
					<h3 className="text-xl font-bold text-gray-800 mb-1">Premium Plan <span className="text-xs font-normal text-gray-400">Basic</span></h3>
					...
					<button className="w-full bg-green-500 text-white py-2 rounded-md font-semibold shadow hover:bg-green-600 mb-2">Pay with Stripe →</button>
					<button className="w-full bg-blue-50 text-blue-700 py-2 rounded-md font-semibold shadow hover:bg-blue-100">Pay with PayPal →</button>
				</div>
			</div>
